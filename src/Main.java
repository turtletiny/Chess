        ...
        while (playing) {
            ...
            while (true) {
                try {
                    ...
                    Move convertedMove = MoveNotation.convertMove(move, board);
                    System.out.println(convertedMove);
                    if (convertedMove == null ||
                            convertedMove.from() == null ||
                            convertedMove.to() == null) {
                        System.out.println("Invalid move");
                        continue;
                    }
                    Point from = convertedMove.from();
                    Point to = convertedMove.to();
